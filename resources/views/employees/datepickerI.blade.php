  <div x-data="appf()" x-init="[initDate(), getNoOfDays()]" x-cloak>
    <div class="container mx-auto py-2 md:py-10">
      <div class="mb-5 w-64">
        <label for="datepicker" class="font-bold mb-1 text-gray-700 block">Fecha de contrato</label>
        <div class="relative">

          <input type="hidden" name="fcontrato" x-ref="date" :value="datepickerValue" />
  ...
  <script>
    ...
    function appf() {
      ...
      if("<?php echo $employee->fecha_contrato ?>"){

       var fecha = "{{$employee->fecha_contrato}}".replace(/^(\d{4})-(\d{2})-(\d{2})$/g, '$2-$3-$1');
     }
