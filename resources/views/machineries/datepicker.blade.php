  <div x-data="app()" x-init="[initDate(), getNoOfDays()]" x-cloak>
    <div class="container mx-auto py-2 md:py-10">
      <div class="mb-5 w-64">
        <label for="datepicker" class="font-bold mb-1 text-gray-700 block">Fecha de compra</label>
        <div class="relative">
  ...
  <script>
    ...
    function app() {
      ...
      if("<?php echo $machinery->fecha_compra ?>"){

       var fecha = "{{$machinery->fecha_compra}}".replace(/^(\d{4})-(\d{2})-(\d{2})$/g, '$2-$3-$1');
     }
