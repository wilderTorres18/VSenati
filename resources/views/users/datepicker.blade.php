  <div x-data="app()" x-init="[initDate(), getNoOfDays()]" x-cloak>
    <div class="container mx-auto py-2 md:py-10">
      <div class="mb-5 w-64">
        <label for="datepicker" class="font-bold mb-1 text-gray-700 block">Fecha de reparación</label>
        <div class="relative">

          <input type="hidden" name="fecha" x-ref="date" :value="datepickerValue" />
  ...
  <script>
    ...
    function app() {
      ...
      if("<?php echo $machinery_maintenance->fecha_reparacion ?>"){

       var fecha = "{{$machinery_maintenance->fecha_reparacion}}".replace(/^(\d{4})-(\d{2})-(\d{2})$/g, '$2-$3-$1');
     }
